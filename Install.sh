...
if [ -f "$FONT_PATH" ]; then
    ...
    if curl -L --progress-bar -o "$FONT_PATH" "https://raw.githubusercontent.com/genius-developer-haha/SillyTavern-Termux/refs/heads/main/MapleMono-ExtraLight.ttf"; then
